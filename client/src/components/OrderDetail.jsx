      ...
      <div className="border-b pb-4 mb-6 flex flex-col lg:flex-row lg:items-start lg:justify-between gap-4">
        ...
        {order.isVerified && (
          <a
            ...
            className="text-white px-4 py-2 md:px-6 md:py-2 border border-[#1C3753] rounded-lg text-sm bg-[#0C0057] transition-colors flex items-center justify-center gap-2 w-full lg:w-auto cursor-pointer"
          >
        ...
        {currentStatus === "shipped" && (
          <>
            ...
            <a
              ...
              // onClick={() => generateInvoice(order)}
              className=" text-[#1C3753] px-6 py-2 border border-[#1C3753] rounded-lg text-sm hover:bg-[#1C3753] hover:text-white transition-colors flex items-center gap-2 cursor-pointer"
            >
              Download Invoice <Download size={18} />
            </a>
          </>
