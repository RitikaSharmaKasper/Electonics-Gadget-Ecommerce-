        ...
        <div className="p-6">
          ...
          <div className="flex gap-4">
            ...
            <div className="flex-1">
              <p className="text-sm text-[#7A1F2B] font-stack-sans font-medium">
                How was the item?
              </p>
          ...
          {/* Textarea */}
          <div className="mt-4">
            <p className="text-sm font-medium text-[#7A1F2B] mb-2">
              Write a review
            </p>
            <textarea
              value={text}
          ...
          {/* <div className="mt-6 flex items-center gap-4">
            <button
              type="button"
              onClick={handleSave}
              className="min-w-[140px] rounded-lg bg-[#7A1F2B] px-6 py-3 text-white text-sm font-medium hover:opacity-95"
            >
              {review ? "Update" : "Save"}
            </button>
          ...
          <div className="mt-6 flex items-center gap-4">
            <button
              ...
              className="min-w-[140px] rounded-lg bg-[#7A1F2B] font-stack-sans px-6 py-3 text-white text-sm font-medium hover:opacity-95 disabled:opacity-70 disabled:cursor-not-allowed flex items-center justify-center gap-2"
            >
              {isSubmitting ? (
                <>
                  <svg
