  ...
  return (
    <div className="lg:px-20 md:px-[60px] px-4 py-[23px] bg-white shadow-sm rounded-lg">
      ...
      <div className=" mx-auto text-start mb-12">
        ...
        <h1 className="text-2xl md:text-3xl lg:text-4xl font-light text-[#7A1F2B] font-stack-sans mb-3">
          {/* Illuminate Your{" "} */}
        ...
        {/* {diwaliProducts?.slice(0, visibleCount).map((p) => {
          ...
          return (
            ...
            >
              ...
              <div className="mt-3">
                <h3 className="lg:text-xl md:text-base text-sm text-center font-serif text-[#7A1F2B] font-stack-sans font-normal line-clamp-1 mb-2">
                  {p.productTittle}
                </h3>
