      ...
      <div className="bg-white">
        <form onSubmit={handleSubmit} className="space-y-4">
          ...
          <button
            ...
            className="w-full bg-[#7A1F2B] text-white hover:  bg-[#7A1F2B] hover:text-white disabled:bg-[#DEDEDE] disabled:text-[#686868] py-3 px-4 rounded-lg font-medium transition-all duration-200 transform hover:scale-[1.02] disabled:scale-100 disabled:cursor-not-allowed"
          >
            {loading ? (
