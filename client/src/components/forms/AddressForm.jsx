      ...
      >
        {!inline && (
          <div className="flex justify-between items-center p-6 border-b border-gray-200 sticky top-0 bg-white rounded-t-xl">
            <h1 className="text-lg sm:text-xl font-semibold font-stack-sans text-[#7A1F2B]">
        ...
        >
          ...
          <div className="space-y-2">
            <p className="text-sm font-medium text-[#7A1F2B]">Address Type</p>
                ...
                <button
                  ...
                  className={`flex items-center gap-2 px-4 py-2 rounded-lg border transition-all ${
                    formData.addressType === type.value
                      ? "border-[#52151d] bg-white text-[#7A1F2B]"
          ...
          <div className="flex flex-col sm:flex-row gap-4 pt-4">
            ...
            <button
              type="submit"
              disabled={isSubmitting}
              className="flex-1 px-6 py-3 bg-[#7A1F2B] text-white font-medium rounded-lg disabled:opacity-70 disabled:cursor-not-allowed flex items-center justify-center gap-2"
            >
              {isSubmitting ? (
                <>
                  <svg
