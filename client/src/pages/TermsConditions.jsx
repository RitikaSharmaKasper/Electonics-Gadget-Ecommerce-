        ...
        <div className="max-w-5xl mx-auto">
          ...
          <div
            ...
            dangerouslySetInnerHTML={{
              __html: termsData?.content || "<p>Welcome to Divinex. By accessing our website and placing an order, you agree to comply with the following Terms & Conditions. Please read them carefully before making a purchase.</p>",
            }}
          />
        </div>
      </section>
