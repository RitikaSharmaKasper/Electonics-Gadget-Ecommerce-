          ...
          <div className="space-y-3">
            ...
            {data?.paymentProof?.url ? (
              <div className="flex items-center justify-between w-full flex-nowrap">
                ...
                /> */}
                  <span className="text-xs text-[#7A1F2B] underline">
                    View Screenshot
                  </span>
                </a>
              </div>
          ...
          {status === "shipped" ? (
            <div className="p-3 border rounded-md bg-[#F8FAFB] text-sm space-y-1">
              <div className="flex items-center justify-between ">
                <span className="text-[#7A1F2B]">Partner</span>{" "}
                <span>{data?.tracking?.carrier}</span>
              </div>
              <div className="flex items-center justify-between ">
                <span className="text-[#7A1F2B]">Tracking ID</span>{" "}
                {data.tracking?.trackingNumber}
              </div>
              <div className="flex items-center justify-between ">
                <span className="text-[#7A1F2B]">Tracking URL:</span>{" "}
                <span>
                  {" "}
                  ...
                  <a
                    ...
                    target="_blank"
                    rel="noreferrer"
                    className="text-[#7A1F2B] underline"
                  >
                    {data?.tracking?.trackingUrl}
                  </a>
                  {/* // )} */}
            ...
            ${trackingId ? "  bg-[#7A1F2B] text-white" : "bg-gray-300 text-gray-600 cursor-not-allowed"}`}
              >
                Save Tracking
              </button>
            </>
        ...
        <div className="flex items-center justify-between w-full flex-nowrap">
          ...
          {[
            ...
            <a
              ...
              target="_blank"
              rel="noreferrer"
              className="flex items-center gap-2 text-[#7A1F2B] shrink-0 cursor-pointer"
              onClick={(e) => {
    ...
    canAccept && !acceptLoading
      ...
      : "bg-gray-300 cursor-not-allowed"
            ...
            <button
              ...
              className="px-6 py-1.5 rounded-md text-[#7A1F2B] bg-white border border-[#52151d]"
            >
              Reject
            </button>
          </>
        ...
        {status === "processing" && (
          <button
            ...
            className="px-6 py-1.5 rounded-md text-sm font-medium bg-[#7A1F2B] text-white"
          >
            Ready to Ship
          </button>
        )}
        ...
        {status === "shipped" && (
          <button
            ...
            className="px-3 py-1.5 text-sm rounded-md text-white bg-[#7A1F2B]"
          >
            Mark as Delivered
          </button>
        )}
