...
const TransporterDetail = () => {
    ...
    return (
      <div className="p-[24px] bg-[#F6F8F9] rounded-md min-h-screen">
        <div className="bg-white rounded-xl p-6">
          <h2 className="text-[20px] font-semibold text-[#7A1F2B] font-stack-sans mb-4">
          ...
          >
            ...
            <div className="flex items-center justify-between px-6 py-4 border-b">
              ...
              <button
                ...
                className="text-gray-500 hover:text-[#7A1F2B] font-stack-sans"
              >
                ✕
              </button>
            </div>
  ...
  ${errors.email ? "border-red-500" : "border-gray-300"}`}
            ...
            <div className="flex justify-end gap-2 px-6 py-4 border-t bg-white">
              ...
              <button
                type="button"
                className="px-4 py-2 rounded-lg bg-[#7A1F2B] text-white hover:  bg-[#7A1F2B]/90"
